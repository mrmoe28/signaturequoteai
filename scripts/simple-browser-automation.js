...
/**
 * Simple Browser Automation for Google Cloud Setup
 * Uses a different approach to work with existing browser
 */
...
async function runAutomation() {
  console.log('🚀 Simple Browser Automation for Google Cloud Setup');
  console.log('==================================================\n');
  ...
  try {
    ...
    process.stdin.once('data', async () => {
      ...
      // Step 2: Run the Playwright automation with a new browser
